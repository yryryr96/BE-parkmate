package com.parkmate.reservationservice.common.response;
...
public enum ResponseStatus {
    ...
    INVALID_RESERVATION_STATUS(HttpStatus.BAD_REQUEST, false, 400, "예약 상태가 유효하지 않습니다."),
    /**
     * 5xx: 서버 오류
     */
    NOT_FOUND_EVENT_DISPATCHER(HttpStatus.INTERNAL_SERVER_ERROR, false, 500, "이벤트 디스패처를 찾을 수 없습니다."),
