...
public class ReservationConfirmEventHandler implements EventHandler<ReservationEvent> {
    ...
    public boolean supports(Object event) {
        return event instanceof ReservationEvent &&
               ((ReservationEvent) event).getEventType() == ReservationEventType.CONFIRMED;
    }
